    ...
    <section id="show-interest" className="relative w-full py-16 md:py-24 bg-transparent">
      <div className="relative z-10 px-4 md:px-8 max-w-5xl mx-auto">
        <AnimatedContent
          ...
          threshold={0.1}
        >
          <h2 className="text-3xl md:text-5xl font-semibold text-gray-900 mb-4 md:mb-6 text-center">
            Show Your Interest
          </h2>
          <p className="text-xl md:text-2xl text-gray-600 mb-10 md:mb-14 text-center max-w-2xl mx-auto">
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex gap-2">
                  <span className="h-12 px-3 flex items-center bg-gray-100 border-2 border-[#dedede] rounded-xl text-gray-600 font-medium">
                    +91
                  </span>
                  <input
                    type="tel"
